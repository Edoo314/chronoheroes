...
setExamples(shuffled)
 ...
 <div style={{ maxWidth: 680, margin: '24px auto 0', padding: '0 24px', marginBottom: 32 }}>
    <div style={{ fontSize: isMobile ? 14 : 16, color: '#6b6a65', lineHeight: 1.75, maxWidth: 480, margin: '0 auto 32px', textAlign: 'center' }}>
     {locale === 'fr' ? (
  <>Découvrez ce que faisaient les personnalités qui ont fait l'Histoire<br />quand ils avaient votre âge exact, au jour près.</>
) : (
  <>Find out what the historical figures who shaped history were doing<br />when they were exactly your age, to the day.</>
)}
    </div>
